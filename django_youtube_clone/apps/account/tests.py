...
class ProfileModelTests(TestCase):
    ...
    def test_default_profile(self):
        default_profile = User.objects.get(username='testUser').profile
        self.assertEqual(str(default_profile), 'testUser')
...
class ChangePasswordViewTests(TestCase):
    ...
    def test_post_change_password_with_wrong_original_password(self):
        ...
        self.c.logout()
        self.assertFalse(self.c.login(username='testUser', password='0002'))
        self.c.logout()
    ...
    def test_post_change_password_with_right_new_password(self):
        ...
        self.c.logout()
        self.assertTrue(self.c.login(username='testUser', password='0002'))
        self.c.logout()
...
class UserDetailViewTests(TestCase):
    ...
    def test_get_user_detail_with_user(self):
        ...
        url = reverse('user_detail', kwargs={'username': 'testUser'})
        res = self.c.get(url)
